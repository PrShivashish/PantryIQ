...
class IngredientGraphService:
    ...
    def _fuzzy_match_ingredient(self, ingredient: str) -> Optional[str]:
        ...
        for graph_ingredient in self.ingredient_graph.nodes():
            # Use SequenceMatcher for similarity (0-1 scale, multiply by 100 for percentage)
            score = SequenceMatcher(None, ingredient.lower(), graph_ingredient.lower()).ratio() * 100
