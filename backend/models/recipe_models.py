"""
Pydantic models for PantryIQ API
"""
...
class RecipeResponse(BaseModel):
    ...
    match_percentage: Optional[float] = Field(None, description="Percentage of user ingredients matched (0-100)")
    matched_ingredients: Optional[List[str]] = Field(None, description="List of ingredients user has")
    total_matched: Optional[int] = Field(None, description="Number of matched ingredients")
    total_user_ingredients: Optional[int] = Field(None, description="Total number of user ingredients")
