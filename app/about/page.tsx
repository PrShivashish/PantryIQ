    ...
    <div className="flex-1 w-full max-w-6xl mx-auto p-6 space-y-12">
      ...
      <div className="text-center space-y-6">
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            PantryIQ revolutionizes how you discover, organize, and enjoy cooking. 
      ...
      <div className="space-y-8">
        <div className="text-center space-y-4">
          <h2 className="text-3xl font-bold tracking-tight">Why Choose PantryIQ?</h2>
      ...
      <Card className="bg-gradient-to-r from-primary/5 to-secondary/5 border-0">
        ...
        <CardContent className="text-center space-y-4">
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            At PantryIQ, we believe that great food brings people together. Our mission is to 
      ...
      <Card className="text-center">
        <CardContent className="pt-8 pb-8 space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Join thousands of home cooks who have already discovered their new favorite recipes on PantryIQ.
          </p>
